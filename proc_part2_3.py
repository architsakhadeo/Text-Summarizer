...
import nltk
import operator
from nltk_tagger_rake_part6 import new_sort_list, content_no_dot, word_frequency, word_degree
from mained import generate_graphviz_graph
import os
import sys
import re
from nltk_tagger_rake_part6 import word_frequency, word_degree
...
filer_10 = open('summary_101.txt','w')
...
filer_25 = open('summary_251.txt','w')
...
filer_33 = open('summary_331.txt','w')
...
filer_39 = open('summary_391.txt','w')
...
filer_45 = open('summary_451.txt','w')
...
filer_15 = open('summary_151.txt','w')
...
filer_20 = open('summary_201.txt','w')
